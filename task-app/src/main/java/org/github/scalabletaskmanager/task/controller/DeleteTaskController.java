...
import org.github.scalabletaskmanager.task.gen.api.DeleteAPI;
...
@RestController
public class DeleteTaskController implements DeleteAPI {

    private final TaskService taskService;
    private final JwtService jwtService;

    @Autowired
    public DeleteTaskController(TaskService taskService, JwtService jwtService) {
